...
const DEFAULT_PAYMENT_METHODS = [
  ...
  // Pagamento automático via Mercado Pago (Fase "Pagamentos automáticos",
  // 2026-08-28) — usado pela Vitrine (PIX/cartão/boleto) e pelo Modo
  // Vendedor presencial (PIX/cartão). Para instalações já existentes, ver a
  // migração idempotente equivalente em migrate.js.
